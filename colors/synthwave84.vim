...
if s:t_Co >= 256
  ...
  hi CursorLineNr ctermfg=16  ctermbg=149 cterm=NONE
  ...
  hi LineNr ctermfg=231 ctermbg=239 cterm=NONE
  hi NonText ctermfg=14 ctermbg=NONE cterm=NONE
  hi Pmenu ctermfg=15 ctermbg=239 cterm=NONE
  ...
  hi Visual ctermfg=233 ctermbg=253 cterm=NONE
